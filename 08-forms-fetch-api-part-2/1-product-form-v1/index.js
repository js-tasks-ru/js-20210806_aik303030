...
export default class ProductForm {
  ...
  getImageList(imageInfoArr) {
    return imageInfoArr.map((imageInfo) => {
  ...
  getImageListInner(imageInfoArr) {
    ...
    return `
        <ul class="sortable-list">
                ${this.getImageList(imageInfoArr)}
        </ul>`;
  }
    ...
    return `
        <div class="form-group form-group__wide" data-element="sortable-list-container">
            ...
            <div data-element="imageListContainer">
                ${this.getImageListInner(this.productInfo)}
            </div>
  ...
  async uploadImage(e) {
    ...
    if (file) {
      ...
      this.subElements.imageListContainer.append(this.getImageItem({
  ...
  updateProductInfo(productInfo) {
    ...
    this.subElements.imageListContainer.innerHTML = this.getImageListInner(productInfo.images);
